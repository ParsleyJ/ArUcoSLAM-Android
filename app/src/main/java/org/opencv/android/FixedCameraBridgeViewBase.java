 ...
 */
public abstract class FixedCameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public FixedCameraBridgeViewBase(Context context, int cameraId) {
        super(context);
    ...
    public FixedCameraBridgeViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
