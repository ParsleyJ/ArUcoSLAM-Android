...
@TargetApi(21)
public class FixedJavaCamera2View extends CameraBridgeViewBase {
    ...
    public FixedJavaCamera2View(Context context, int cameraId) {
        super(context, cameraId);
    }

    public FixedJavaCamera2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
